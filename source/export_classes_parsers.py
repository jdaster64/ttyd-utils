...
g_StructDefs = {
    ...
    "BattleUnitKind": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0xac, "UA_ShowHpGauge", bd.BDType.U32, 30),
    ...
    "BattleUnitKindPart": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0x40, "PA_Unknown23", bd.BDType.U32, 23),
    ...
    "BattleWeapon": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0x64, "TC_OnlyTargetSelfOrSameSpecies", bd.BDType.U32, 13),
            ...
            FieldMetadata(0x7c, "TW_PreferSameAllianceButNot2", bd.BDType.U32, 5),
