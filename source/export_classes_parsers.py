...
g_StructDefs = {
    ...
    "BattleUnitKind": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0xac, "UA_ShellShieldEnabled", bd.BDType.U32, 6),
            FieldMetadata(0xac, "UA_Unknown12", bd.BDType.U32, 12),
            FieldMetadata(0xac, "UA_Unknown13", bd.BDType.U32, 13),
            FieldMetadata(0xac, "UA_DisableSpinHammer", bd.BDType.U32, 14),
            FieldMetadata(0xac, "UA_IsUndead", bd.BDType.U32, 16),
            FieldMetadata(0xac, "UA_IsCorpse", bd.BDType.U32, 17),
            FieldMetadata(0xac, "UA_IsLeader", bd.BDType.U32, 18),
            FieldMetadata(0xac, "UA_Unknown19", bd.BDType.U32, 19),
            FieldMetadata(0xac, "UA_DisplayOff", bd.BDType.U32, 20),
            FieldMetadata(0xac, "UA_HpGaugeOff", bd.BDType.U32, 21),
            FieldMetadata(0xac, "UA_Unknown22", bd.BDType.U32, 22),
            FieldMetadata(0xac, "UA_Unknown28", bd.BDType.U32, 28),
            FieldMetadata(0xac, "UA_Unknown29", bd.BDType.U32, 29),
            FieldMetadata(0xac, "UA_DisableDamage", bd.BDType.U32, 30),
    ...
    "BattleUnitKindPart": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0x08, "model_name", bd.BDType.CSTRING),
            ...
            FieldMetadata(0x40, "PA_MainBody", bd.BDType.U32, 0),
            FieldMetadata(0x40, "PA_SecondaryBody", bd.BDType.U32, 1),
            FieldMetadata(0x40, "PA_BombOnlyBody", bd.BDType.U32, 2),
            FieldMetadata(0x40, "PA_Unknown3", bd.BDType.U32, 3),
            FieldMetadata(0x40, "PA_AntiBombTarget", bd.BDType.U32, 4),
            FieldMetadata(0x40, "PA_Unknown5", bd.BDType.U32, 5),
            FieldMetadata(0x40, "PA_Unknown6", bd.BDType.U32, 6),
            FieldMetadata(0x40, "PA_WeakToAttackFxR", bd.BDType.U32, 7),
            FieldMetadata(0x40, "PA_WeakToIcePower", bd.BDType.U32, 8),
            FieldMetadata(0x40, "PA_Unknown9", bd.BDType.U32, 9),
            FieldMetadata(0x40, "PA_Unknown10", bd.BDType.U32, 10),
            ...
            FieldMetadata(0x40, "PA_IsClone", bd.BDType.U32, 14),
            FieldMetadata(0x40, "PA_DisablePaperAnim", bd.BDType.U32, 15),
            FieldMetadata(0x40, "PA_NonTargetable", bd.BDType.U32, 16),
            FieldMetadata(0x40, "PA_Unknown17", bd.BDType.U32, 17),
            FieldMetadata(0x40, "PA_BodyScopeCannotTarget", bd.BDType.U32, 18),
            ...
            FieldMetadata(0x40, "PA_DisplayOff", bd.BDType.U32, 24),
            FieldMetadata(0x40, "PA_ShadowOff", bd.BDType.U32, 25),
            FieldMetadata(0x40, "PA_BlurOn", bd.BDType.U32, 26),
            FieldMetadata(0x40, "PA_ScaleIndependence", bd.BDType.U32, 27),
            FieldMetadata(0x40, "PA_Independence", bd.BDType.U32, 28),
            FieldMetadata(0x40, "PA_IsInvincible", bd.BDType.U32, 29),
    ...
    "BattleWeapon": StructMetadata(
        ...
        fields=[
            ...
            FieldMetadata(0x14, "unk_0x14", bd.BDType.FLOAT),
            FieldMetadata(0x18, "stylish_multiplier", bd.BDType.U8),
            FieldMetadata(0x19, "unk_0x19", bd.BDType.U8),
            FieldMetadata(0x1a, "bingo_slot_inc_chance", bd.BDType.U8),
            FieldMetadata(0x1b, "unk_0x1b", bd.BDType.U8),
            ...
            FieldMetadata(0x64, "TC_OnlyTargetMario", bd.BDType.U32, 16),
            FieldMetadata(0x64, "TC_OnlyTargetTreeOrSwitch", bd.BDType.U32, 17),
            FieldMetadata(0x64, "TC_OnlyTargetMainSecondParts", bd.BDType.U32, 20),
            FieldMetadata(0x64, "TC_OnlyTargetMainSecondBombParts", bd.BDType.U32, 21),
            FieldMetadata(0x64, "TC_SingleTarget", bd.BDType.U32, 24),
            FieldMetadata(0x64, "TC_MultipleTarget", bd.BDType.U32, 25),
            FieldMetadata(0x64, "TC_CannotTargetAnything", bd.BDType.U32, 31),
            FieldMetadata(0x68, "TP_TattleScope", bd.BDType.U32, 0),
            FieldMetadata(0x68, "TP_CannotTargetFloating2", bd.BDType.U32, 1),
            ...
            FieldMetadata(0x68, "TP_CannotTargetLow?", bd.BDType.U32, 15),
            FieldMetadata(0x68, "TP_RecoilDamage", bd.BDType.U32, 20),
            FieldMetadata(0x68, "TP_CanOnlyTargetFrontmost", bd.BDType.U32, 24),
            FieldMetadata(0x68, "TP_CannotTargetShellShield", bd.BDType.U32, 25),
            ...
            FieldMetadata(0x6f, "unk_0x6f", bd.BDType.U8),
            ...
            FieldMetadata(0x74, "SP_FreezeCrush", bd.BDType.U32, 7),
            ...
            FieldMetadata(0x74, "SP_PlaysAttackFxSounds", bd.BDType.U32, 11),
            ...
            FieldMetadata(0x74, "SP_Unknown15", bd.BDType.U32, 15),
            FieldMetadata(0x74, "SP_CanUseIfConfused", bd.BDType.U32, 16),
            FieldMetadata(0x74, "SP_Unguardable", bd.BDType.U32, 17),
            FieldMetadata(0x74, "SP_ContactsClones", bd.BDType.U32, 18),
    ...
    "NpcSetupInfo": StructMetadata(
        "NpcSetupInfo", 0x5c, array=ZERO_TERMINATED,
        fields=[
            FieldMetadata(0x00, "name", bd.BDType.CSTRING),
            FieldMetadata(0x04, "flags", bd.BDType.U32),
            FieldMetadata(0x08, "reaction_flags", bd.BDType.U32),
            FieldMetadata(0x0c, "init_event", bd.BDType.POINTER),
            FieldMetadata(0x10, "move_event", bd.BDType.POINTER),
            FieldMetadata(0x14, "talk_event", bd.BDType.POINTER),
            FieldMetadata(0x18, "dead_event", bd.BDType.POINTER),
            FieldMetadata(0x1c, "find_event", bd.BDType.POINTER),
            FieldMetadata(0x20, "lost_event", bd.BDType.POINTER),
            FieldMetadata(0x24, "return_event", bd.BDType.POINTER),
            FieldMetadata(0x28, "blow_event", bd.BDType.POINTER),
            FieldMetadata(0x2c, "territory_type", bd.BDType.S32),
            FieldMetadata(0x30, "territory_base_x", bd.BDType.FLOAT),
            FieldMetadata(0x34, "territory_base_y", bd.BDType.FLOAT),
            FieldMetadata(0x38, "territory_base_z", bd.BDType.FLOAT),
            FieldMetadata(0x3c, "territory_loiter_x", bd.BDType.FLOAT),
            FieldMetadata(0x40, "territory_loiter_y", bd.BDType.FLOAT),
            FieldMetadata(0x44, "territory_loiter_z", bd.BDType.FLOAT),
            FieldMetadata(0x48, "search_range", bd.BDType.FLOAT),
            FieldMetadata(0x4c, "search_angle", bd.BDType.FLOAT),
            FieldMetadata(0x50, "homing_range", bd.BDType.FLOAT),
            FieldMetadata(0x54, "homing_angle", bd.BDType.FLOAT),
            FieldMetadata(0x58, "battle_info_id", bd.BDType.S32),
        ]),
    ...
    "PSndSfxEntry": StructMetadata(
        "PSndSfxEntry", 0x14, array=4242,
        fields=[
            FieldMetadata(0x00, "sfx1", bd.BDType.CSTRING),
            FieldMetadata(0x04, "flags1", bd.BDType.U16),
            FieldMetadata(0x06, "flags2", bd.BDType.U16),
            FieldMetadata(0x08, "sfx2", bd.BDType.CSTRING),
            FieldMetadata(0x0c, "unk1", bd.BDType.U8),
            FieldMetadata(0x0d, "unk2", bd.BDType.U8),
            FieldMetadata(0x0e, "unk3", bd.BDType.U16),
            FieldMetadata(0x10, "unk4", bd.BDType.U32),
        ]),
